...
<?php
	$pageTitle = 'Home';
	include_once(SHARED_PATH . '/publicHeader.php');
 ...
 ?>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo urlFor('/images/project-7.jpg');?>)">
			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					...
			   					<h2>Welcome to</h2>
									...
									<p><a class="btn btn-warning btn-lg" href="#">Click here to view your result</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
		   	</li>
		   	<li style="background-image: url(<?php echo urlFor('/images/img_bg_5.jpg');?>)">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>HUMILITY</h1>
									<h2>We see our relationship with our pupils and students as the essence of our corporate being/existence. </h2>
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>INTEGRITY</h1>
									<h2>We relate with our pupils / students, parents and staff with a high sense of transparency. </h2>
									<p><a class="btn btn-primary btn-lg" href="#">Join Us Now!</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>RESILENCE</h1>
									<h2>We make our professionalism and entrepreneurial proficiency and acumen to excel in all challenging situations. </h2>
									<p><a class="btn btn-primary btn-lg" href="#">Join Us Now!</a></p>
			   				</div>
			   			</div>
			   		</div>
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>EMPATHY</h1>
									<h2>We always put ourselves in the position of our Pupils/Students, Parents and staff.</h2>
									<p><a class="btn btn-primary btn-lg" href="#">Join Us Now!</a></p>
			   				</div>
			   			</div>
			   		</div>
...
<?php 
	include_once(SHARED_PATH . '/publicFooter.php');
 ?>