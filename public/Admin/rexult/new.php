...
if(is_post_request()) {
  $args = $_POST['rexult'];
  $rexult = new Result($args);
  $result = $rexult->save();

  if($result === true) {
    $new_id = $rexult->id;
    $session->message('Result added Successfully.');
    redirect_to(urlFor('/admin/rexult/show.php?id=' . $new_id));
  } else {
...
?>
 ...
 <?php $page_title = 'Command:: Add Result';
    ...
    <div class="col-md-9 pt-4 rounded">
      ...
      <div class="row mx-auto">
        <div class="col-md-6 text-center">
          <form action="<?php echo urlFor('/admin/rexult/new.php'); ?>" method="post">
