...
if(is_post_request()) {
  ...
  if($result === true) {
    $new_id = $arm->id;
    $session->message('Arm created Successfully.');
    redirect_to(urlFor('/admin/arm/show.php?id=' . $new_id));
  } else {
...
?>
 ...
 <?php $page_title = 'Command:: Add Arm';
    ...
    <div class="col-md-9 pt-4 rounded">
      ...
      <div class="row mx-auto">
        <div class="col-md-6 text-center">
          <form action="<?php echo urlFor('/admin/arm/new.php'); ?>" method="post">
            <?php include('form_fields.php');?>
            
            <div class="form-group">
              <button class="btn btn-primary">Create Arm</button>
